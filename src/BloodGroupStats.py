    ...
    def getNucleotidePercentage(self, nucleotide):
        ...
        if(totalNucleotideCount == 0):
            ...
            if(nucleotide=='A'):
                ...
                raise Exception ('I do not know what this nucleotide is:' + str(nucleotide))
        
    def getMostCommonBase(self):   
        maxPolymorphismTypeCount = max((self.matchCount, self.mismatchCount, self.inCount, self.delCount))
        maxNucleotideTypeCount = max((self.aCount, self.gCount, self.cCount, self.tCount))
        ...
        if(maxPolymorphismTypeCount==self.matchCount):
            ...
            if(maxNucleotideTypeCount==self.aCount):
                ...
                raise Exception('I do not know what to do with this max value, something is wrong.')
